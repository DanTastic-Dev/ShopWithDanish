  ...
  return (
    <PageWrapper>
      <div className="min-h-screen p-6">
        <h1 className="text-2xl font-bold mb-6 text-light-text dark:text-dark-text">📦 My Orders</h1>
        ...
        {orders.length === 0 ? (
          ...
          orders.map(order => (
            <div
              key={order.id}
              className="bg-light-surface dark:bg-dark-surface text-light-text dark:text-dark-text rounded shadow-soft dark:shadow-soft-dark p-4 mb-6 border border-border-light dark:border-border-dark"
            >
              ...
              <div className="text-right mt-3 text-primary dark:text-primary-dark font-bold">
