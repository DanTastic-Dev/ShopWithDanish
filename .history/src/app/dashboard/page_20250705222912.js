      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="max-w-md mx-auto w-full">
          <input
            ...
            className="w-full px-4 py-2 mb-6 border border-border-light dark:border-border-dark rounded bg-light-surface dark:bg-dark-surface text-light-text dark:text-dark-text"
          />
        </div>
