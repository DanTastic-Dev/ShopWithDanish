  ...
  return (
    <PageWrapper>
      <div className="min-h-screen px-4 md:px-8 py-10">
        <h1 className="text-3xl font-bold mb-10 text-light-text dark:text-dark-text">📊 Shop Analytics</h1>

        <div className="grid sm:grid-cols-2 gap-6 mb-10">
          <div className="bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-soft dark:shadow-soft-dark">
            <p className="text-lg font-medium text-light-text dark:text-dark-text">🧾 Total Orders</p>
            <p className="text-3xl font-bold text-primary dark:text-primary-dark mt-2">{totalOrders}</p>
          </div>
          <div className="bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-soft dark:shadow-soft-dark">
            <p className="text-lg font-medium text-light-text dark:text-dark-text">💰 Total Revenue</p>
